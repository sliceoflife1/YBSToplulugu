-- 041_prevent_duplicate_profiles.sql
-- Yeni kullanıcı oluşturulduğunda profil eklerken mükerrer e-posta veya ID çakışmasında hata vermek yerine güvenli işlem sağlar.
